    ...
    <ul className="sidebar-menu ps-0 h-100">
      ...
      <div className="sidebar-bottom">
        <li onClick={() => handleSectionClick("configuracion")} className="etiqueta1">
          <div className={`sidebar-link-vertical ${activeSection === 'configuracion' ? 'active' : ''}`}>
            <FaCogs size={20} style={{ marginRight: 8, color: activeSection === 'configuracion' ? '#FFFFFF' : '#2196f3' }} />
            CONFIG
          </div>
        </li>
